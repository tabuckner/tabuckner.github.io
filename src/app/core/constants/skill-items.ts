import { SkillItemModel } from '../interfaces/skill-item-model';
import { ExperienceLevels } from '../enums/experience-levels.enum';
import { PreferenceLevels } from '../enums/preference-levels.enum';

export const SKILL_ITEMS: SkillItemModel[] = [
  {
    name: 'TypeScript',
    imageUrl: '/assets/img/skills/typescript.png',
  ...
  },
  {
    ...
    imageUrl: '/assets/img/skills/angular-material.png',
    experience: ExperienceLevels.best,
    preference: PreferenceLevels.best
  },
  {
  ...
  },
  {
    ...
    imageUrl: '/assets/img/skills/es-next.png',
    experience: ExperienceLevels.best,
    preference: PreferenceLevels.better
  },
  {
  ...
  },
  {
    ...
    imageUrl: '/assets/img/skills/material-design.png',
    experience: ExperienceLevels.better,
    preference: PreferenceLevels.best
  },
  {
  ...
  {
    name: 'Jekyll',
    imageUrl: '/assets/img/skills/jekyll.svg',
    experience: ExperienceLevels.better,
    preference: PreferenceLevels.good
  },
  {
    name: 'Dart',
    imageUrl: '/assets/img/skills/dart.png',
    experience: ExperienceLevels.good,
    preference: PreferenceLevels.better
  },
  {
    name: 'Flutter',
    imageUrl: '/assets/img/skills/flutter.svg',
    experience: ExperienceLevels.average,
    preference: PreferenceLevels.better
  },
  {
